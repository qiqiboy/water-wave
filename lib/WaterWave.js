...
var TARGET_CLASS = 'water-wave-target';
var WATER_DURATION_CLASS = 'water-wave-duration';
...
var Water = function (_Component) {
    ...
    function Water() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Water.__proto__ || Object.getPrototypeOf(Water)).call.apply(_ref, [this].concat(args))), _this), _this.createWave = function (ev) {
            var canvasParent = _this.refs.canvas.parentNode;
    ...
    _createClass(Water, [{
        ...
        value: function componentDidMount() {
            ...
            Object.keys(events.event2code).forEach(function (type) {
                (events.event2code[type] === 2 ? document : canvasParent).addEventListener(type, _this2, false);
            });
        }
    }, {
        ...
        value: function componentWillUnmount() {
            ...
            Object.keys(events.event2code).forEach(function (type) {
                (events.event2code[type] === 2 ? document : canvasParent).removeEventListener(type, _this3, false);
            });
        }
    }, {
        key: 'handleEvent',
