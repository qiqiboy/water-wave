...
var Ripple = /*#__PURE__*/function () {
  ...
  createClass(Ripple, [{
    ...
    value: function render() {
      ...
      var _this$rippleData = slicedToArray(this.rippleData, 8),
...
var Water = /*#__PURE__*/function (_Component) {
  inherits(Water, _Component);

  var _super = createSuper(Water);

  function Water() {
    var _this;

    classCallCheck(this, Water);
    ...
    _this.createWave = function (ev) {
      ...
      if (!disabled) {
        ...
        var _this$getOrigin = _this.getOrigin(width, height),
            _this$getOrigin2 = slicedToArray(_this$getOrigin, 2),
        ...
        var run = function run() {
          rafDom.cancelAnimationFrame(_this.timer);
          ...
          if (_this.ripples.length) {
            _this.timer = rafDom.requestAnimationFrame(run);
...
Water.propTypes = {
  ...
  radius: PropTypes__default['default'].oneOfType([PropTypes__default['default'].oneOf(['auto']), PropTypes__default['default'].number]).isRequired,
  alpha: PropTypes__default['default'].number.isRequired,
  press: PropTypes__default['default'].oneOf(['up', 'down']).isRequired,
  effect: PropTypes__default['default'].oneOf(['ripple', 'wave', 'starLight', 'petal', 'helix']).isRequired,
  stopPropagation: PropTypes__default['default'].bool
};
